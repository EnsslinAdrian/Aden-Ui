...
@Component({
  selector: 'app-confetti-explosion-effect',
  imports: [UiPlayground],
  templateUrl: './confetti-explosion-effect.html',
  styleUrl: './confetti-explosion-effect.scss',
})
export class ConfettiExplosionEffect extends BaseUi {
  override meta: ComponentMeta = {
    title: 'Confetti Explosion Effect',
    description: 'A dynamic canvas-based confetti animation featuring physics-driven particles, customizable settings, and smooth performance. Ideal for celebrating actions, achievements, or user milestones in modern UI environments.',
    slug: 'confetti-explosion-effect',
  };
  ...
  get FILE_COMPONENT() { return 'confetti'; }
  ...
  ngOnDestroy() {
    if (isPlatformBrowser(this.platformId)) {
      ...
      // Observer beenden (Wichtig gegen Memory Leaks)
