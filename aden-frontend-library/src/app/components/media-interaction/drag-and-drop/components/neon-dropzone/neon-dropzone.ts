...
@Component({
  selector: 'app-neon-dropzone',
  imports: [UiPlayground],
  templateUrl: './neon-dropzone.html',
  styleUrl: './neon-dropzone.scss',
})
export class NeonDropzone extends BaseUi {
  override meta: ComponentMeta = {
    title: 'Neon Dropzone',
    description: 'A stylish drag-and-drop file uploader with drag state animations and file list management.',
    slug: 'neon-dropzone',
  };
